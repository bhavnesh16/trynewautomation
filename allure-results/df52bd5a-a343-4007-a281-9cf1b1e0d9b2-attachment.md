...
- Name: e2e.spec.ts >> Admin End to End Tests
- Location: tests\e2e.spec.ts:80:11

# Error details

```
Error: page.goto: net::ERR_ABORTED at https://eventhub.rahulshettyacademy.com/admin/events
Call log:
  - navigating to "https://eventhub.rahulshettyacademy.com/admin/events", waiting until "networkidle"
