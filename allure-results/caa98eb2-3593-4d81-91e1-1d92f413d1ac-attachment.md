...
- Name: e2e.spec.ts >> End to End Tests >> sample login testss
- Location: tests\e2e.spec.ts:11:9
...
```ts
  ...
  8  |   }
  9  |   async goto() {
> 10 |     await this.page.goto('https://eventhub.rahulshettyacademy.com/login',{ timeout: 50000 });
     |                     ^ Error: page.goto: net::ERR_ABORTED at https://eventhub.rahulshettyacademy.com/login
  11 |   }
  12 |   
